...
//   tminus.imag()=-t2*sin(phi_mag);
  ...
  double re_tplus1  = (t11+t12*cos(phi_mag))/sqrt(2.0);
  double re_tminus1 = (t11-t12*cos(phi_mag))/sqrt(2.0);
  double im_tplus1  = (t12*sin(phi_mag))/sqrt(2.0);
  double im_tminus1 = (-1.0*t12*sin(phi_mag))/sqrt(2.0);

  tplus1  = complex<double>(re_tplus1 , im_tplus1 );
  tminus1 = complex<double>(re_tminus1, im_tminus1);
